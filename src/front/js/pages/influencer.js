    ...
    return (
        <div>
            <div className="flex items-center justify-center">
                <div>
                    <img className="rounded-full w-32 h-32" src="https://climate-xchange.org/wp-content/uploads/2018/09/Ryan-Illustrated-Headshot-Circle-01.png" alt="image description" />
                </div>
            </div>
            ...
            <div className="flex items-end justify-center">
                <div className="my-4 h-0.5 border-t-1 bg-gray-400  w-[22rem]">
                </div>
            </div>
            ...
            <div className="inline-flex">
                ...
                <div className="px-4 w-[12rem]">
                    <span className="block text-sm font-semibold"><FontAwesomeIcon icon={faInstagram} className="ml-auto bg-gray text-3xl" /> @IG</span>
                    ...
                    <span className="block text-sm"><FontAwesomeIcon icon={faSolidHeart} className="ml-auto text-red-700" /> 800 Likes</span>
                    <span className="block text-sm">250 Comentarios</span>
                    <span className="block text-sm">100 Branded Posts</span>
                </div>

                <div className="px-4">
                    <span className="block text-sm font-semibold"><FontAwesomeIcon icon={faTiktok} className="ml-auto text-accent-two text-3xl" />@TikTok</span>
                    <span className="block text-sm">ER%: 4.5%</span>
                    <span className="block text-sm">10.000 Seguidores</span>
                    <span className="block text-sm">2000 Publicaciones</span>
                    <span className="block text-sm"><FontAwesomeIcon icon={faSolidHeart} className="ml-auto text-red-700" /> 800 Likes</span>
