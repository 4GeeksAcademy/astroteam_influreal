            ...
            <div className="flex justify-center w-secreen relative mt-5">
                ...
                (<>
                    <div className="flex flex-col gap-2">
                        <input type="text" name="lista" id="lista" className="w-full border-1 py-2 px-1" placeholder="Nombre de la Lista" />
                ...
                :
                (
                    <button onClick={() => handleCrearLista()} className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 bg-button-background text-white py-2 px-4 rounded">
                        Crear Lista nueva
                    </button>
                )}           
            </div>
